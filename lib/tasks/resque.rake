...
namespace :resque do
  ...
  task :start_workers => :environment do
    #run_worker('upload_to_youtube', 1)
    #run_worker('delete_from_youtube', 1)
    #run_worker('upload_to_soundcloud', 1)
    #run_worker('update_in_soundcloud', 1)
    #run_worker('delete_from_soundcloud', 1)
    #run_worker('get_remote_thumbnail_for_video', 1)
  end
